  ...
  return (
    <div className="group">
      ...
      <div className="flex justify-between pb-2 md:w-4/12">
        <button
          className="btn btn-accent group-hover:bg-primary group-hover:text-accent cursor-pointer group-hover:hover:bg-secondary group-hover:hover:text-primary w-6/12 mt-2 group btn-sm md:btn-md"
          onClick={onTake}
        >
          Take
        </button>
