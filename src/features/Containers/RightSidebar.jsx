...
function RightSidebar() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="relative  pb-5  bg-white flex flex-col  h-full">
          {/* Header */}
          <div className="navbar items-center  flex pl-4 pr-4 bg-white  shadow-md ">
            <button
              className="float-left w-8  btn btn-circle btn-outline btn-sm"
              onClick={() => close()}
            >
              <p className="h-3 w-3">X</p>
            </button>
            <span className="ml-2 font-bold text-xl">{header}</span>
          </div>

          {/* ------------------ Content Start ------------------ */}
          <div className="overflow-y-scroll pl-4 pr-4 h-full">
